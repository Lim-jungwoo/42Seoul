...
interface nabigationType {
  isListHeader: string;
  setBeforeNabiNum: React.Dispatch<React.SetStateAction<number>> | null;
  setNabiNum: React.Dispatch<React.SetStateAction<number>>;
}

export default function NabigationBar({ isListHeader, setBeforeNabiNum, setNabiNum }: nabigationType) {
